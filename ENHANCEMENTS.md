...
connecting DosBox to its MIDI port (specified as the "mididevice").
However, native MT-32 emulation is now available as an alternative. Simply
specify the path to the ROM directory in your configuration file:
